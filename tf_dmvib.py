...
x = layers.Dense(16,activation="relu")(z_merge) # shared latent representation
...
print('TESTING: Accuracy={:>8.4f}, Total loss={:>8.4f}, KL_v1={:>8.4f}, KL_v2={:>8.4f}, CE={:8.4f}'.format(
